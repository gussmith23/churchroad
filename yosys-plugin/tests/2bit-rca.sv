...
// CHECK: (let v16 (Op1 (Extract 0 0) v13))
// CHECK: (union v5 (Op1 (Extract 0 0) v16))
// CHECK: (let v17 (Op1 (Extract 0 0) v14))
// CHECK: (union v6 (Op1 (Extract 0 0) v17))
// CHECK: (let v18 (Op1 (Extract 0 0) v13))
// CHECK: (union v7 (Op1 (Extract 1 1) v18))
// CHECK: (let v19 (Op1 (Extract 0 0) v14))
// CHECK: (union v8 (Op1 (Extract 1 1) v19))
